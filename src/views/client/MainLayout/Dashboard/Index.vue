    ...
    <v-row class="my-5">
      <v-col lg="4" md="4" sm="12">
        <v-card class="mx-auto" max-width="400">
          ...
          <v-card-actions>
            <v-btn color="orange" text @click="navigateBookAppointment"> Book Appointment </v-btn>
      ...
      <v-col lg="4" md="4" sm="12">
        <v-card class="mx-auto" max-width="400">
          ...
          <v-card-actions>
            <v-btn color="orange" text> Book Appointment </v-btn>

            <v-btn color="orange" text @click="navigateBookAppointment"> Explore </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
      <v-col lg="4" md="4" sm="12">
